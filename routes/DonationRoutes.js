...
const session = await stripe.checkout.sessions.create({
    ...
    mode:'payment',
    success_url: "https://yumyard.vercel.com/DonationSuccessful?session_id={CHECKOUT_SESSION_ID}",
    cancel_url: "https://yumyard.vercel.com/DonationFailed?session_id={CHECKOUT_SESSION_ID}&success=false",
